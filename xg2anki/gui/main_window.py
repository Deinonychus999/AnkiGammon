...
from xg2anki.gui.widgets import PositionListWidget
from xg2anki.gui.dialogs import SettingsDialog, ExportDialog, InputDialog


class MainWindow(QMainWindow):
    """Main application window for XG2Anki."""
    ...
    def _setup_ui(self):
        ...
        self.setWindowTitle("XG2Anki - Backgammon Analysis to Anki")
    ...
    def _setup_menu_bar(self):
        ...
        act_about = QAction("&About XG2Anki", self)
    ...
    def show_documentation(self):
        ...
        QDesktopServices.openUrl(QUrl("https://github.com/yourusername/xg2anki"))
    ...
    def show_about_dialog(self):
        ...
        QMessageBox.about(
            ...
            <p><a href="https://github.com/yourusername/xg2anki">GitHub Repository</a></p>
            """
        )
