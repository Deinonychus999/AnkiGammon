...
from flashgammon.gui.main_window import MainWindow
...
def set_windows_app_id():
    ...
    if sys.platform == 'win32':
        try:
            ...
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID('FlashGammon.GUI.1.0')
        except Exception:
...
def run_gui():
    ...
    app.setApplicationName("FlashGammon")
    app.setOrganizationName("FlashGammon")
    app.setOrganizationDomain("github.com/yourusername/flashgammon")
