"""Command-line interface for FlashGammon."""
...
def main(input_file, format, output, deck_name, show_options, input_format, color_scheme, interactive_moves, gnubg_path, gnubg_ply, use_gnubg, interactive, gui):
    ...
    if not input_file or interactive:
        from flashgammon.interactive import run_interactive
        run_interactive()
        return

    click.echo(f"FlashGammon - Converting backgammon analysis to Anki flashcards...")
    click.echo()
