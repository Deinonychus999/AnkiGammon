"""Interactive CLI mode for FlashGammon - user-friendly position collection."""
...
class InteractiveSession:
    ...
    def show_welcome(self):
        ...
        click.echo(click.style("  FlashGammon - Backgammon Analysis to Anki Flashcards", fg='cyan', bold=True))
        click.echo(click.style("=" * 60, fg='cyan'))
        click.echo()
    ...
    def show_help(self):
        ...
        click.echo()
        click.echo(click.style("=" * 60, fg='cyan'))
        click.echo(click.style("  How to use FlashGammon", fg='cyan', bold=True))
        click.echo(click.style("=" * 60, fg='cyan'))
        click.echo()
        ...
        click.echo()
        click.echo(click.style("Using FlashGammon:", fg='yellow', bold=True))
    ...
    def export_deck(self, decisions: List[Decision], deck_name: str,
        ...
        from flashgammon.cli import export_apkg, export_ankiconnect

        output_dir = Path.cwd() / "flashgammon_output"
