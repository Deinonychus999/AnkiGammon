...
CLASSIC = ColorScheme(
    ...
    bar="#DEB887",            # Board surface (checkers stay visible, issue #47)
    text="#000000",           # Black
...
FOREST = ColorScheme(
    ...
    bar="#A8C5A0",            # Board surface (checkers stay visible, issue #47)
    text="#000000",           # Black
...
OCEAN = ColorScheme(
    ...
    bar="#87CEEB",            # Board surface (checkers stay visible, issue #47)
    text="#000000",           # Black
...
DESERT = ColorScheme(
    ...
    bar="#D4A574",            # Board surface (checkers stay visible, issue #47)
    text="#000000",           # Black
...
SUNSET = ColorScheme(
    ...
    bar="#D4825A",            # Board surface (checkers stay visible, issue #47)
    text="#000000",           # Black
